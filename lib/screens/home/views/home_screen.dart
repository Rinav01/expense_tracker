    ...
    return FutureBuilder<List<Expense>>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              // Display the appropriate screen based on selected index
              index == 0 ? MainScreen(snapshot.data!) : const StatScreen(),
            ],
          ),
          // Bottom Navigation Bar with clipped corners
          bottomNavigationBar: ClipRRect(
            borderRadius: const BorderRadius.vertical(top: Radius.circular(30)),
            child: BottomNavigationBar(
              onTap: (value) => setState(() => index = value),
              currentIndex: index, // Ensure currentIndex is set
              items: [
